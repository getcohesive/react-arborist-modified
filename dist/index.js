...
function $19606728da91aedd$export$e1a8e267487c59d1(id) {
    return {
        type: "EDIT",
        id: id
    };
...
function $a95e14a2a021f1d6$export$d7ddd398f22d79ef(id) {
    return {
        type: "FOCUS",
        id: id
    };
...
function $007f9a2edf7eef1c$export$715c0d031ede7907(node) {
    ...
    const [_, ref, preview] = (0, $8zHUo$reactdnd.useDrag)(()=>({
            ...
            start: ()=>{
                tree.dispatch((0, $21a3cfea9624f26e$export$e324594224ef24da).dragStart(node.id));
            },
            end: (item, monitor)=>{
                ...
                if (drop && drop.parentId) {
                    const parentId = drop.parentId === (0, $b4b29088977a3260$export$ec71a3379b43ae5c) ? null : drop.parentId;
...
function $8ded640590393a1a$var$canDrop(above, below) {
    if (!above) return true;
    let n = above;
    if ((0, $9ba0f9a5c47c04f2$export$4210f5ea57fbae57)(above) && above !== below) n = above.parent;
    while(n){
...
function $8ded640590393a1a$export$f502ca02ebb85a1c(args) {
    ...
    if (!$8ded640590393a1a$var$canDrop(above, below)) return {
        drop: null,
        cursor: $8ded640590393a1a$var$noCursor()
    };
    ...
    /* The above node is an item or a closed folder */ if ((0, $9ba0f9a5c47c04f2$export$5318634f2ee07019)(above) || (0, $9ba0f9a5c47c04f2$export$4210f5ea57fbae57)(above)) {
...
function $c3ca8fbf6c41abd1$export$57afafec4637d997(el, node) {
    ...
    const [_, dropRef] = (0, $8zHUo$reactdnd.useDrop)(()=>({
            ...
            canDrop: (item, m)=>{
                ...
                const { drop: drop  } = (0, $8ded640590393a1a$export$f502ca02ebb85a1c)({
                    element: el.current,
                    offset: offset,
                    indent: tree.indent,
                    node: node,
                ...
                for (let id of item.dragIds){
                    ...
                    if (drag.isInternal && (0, $9ba0f9a5c47c04f2$export$1e38f72c6c546f70)(dropParent, drag)) return false;
                }
                return true;
            },
            hover: (item, m)=>{
                if (m.canDrop()) {
                    ...
                    const { cursor: cursor  } = (0, $8ded640590393a1a$export$f502ca02ebb85a1c)({
                        element: el.current,
                        offset: offset,
                        indent: tree.indent,
                        node: node,
...
class $c0491d23d353beb3$export$e2da3477247342d1 {
    constructor(store, props, list, listEl){
        ...
        /* Changes here must also be made in update() */ this.root = (0, $b4b29088977a3260$export$882461b6382ed46c)(this);
        this.visibleNodes = (0, $619fcdbdc1238c29$export$5897d8d7c7a3d871)(this);
        this.idToIndex = (0, $6f261e3463b2c9f6$export$c6d108d7c8095f19)(this.visibleNodes);
    }
    /* Changes here must also be made in constructor() */ update(props) {
        this.props = props;
        this.root = (0, $b4b29088977a3260$export$882461b6382ed46c)(this);
        this.visibleNodes = (0, $619fcdbdc1238c29$export$5897d8d7c7a3d871)(this);
        this.idToIndex = (0, $6f261e3463b2c9f6$export$c6d108d7c8095f19)(this.visibleNodes);
    }
    ...
    accessChildren(data) {
        ...
        return $9ba0f9a5c47c04f2$exports.access(data, get) ?? null;
    }
    accessId(data) {
        const get = this.props.idAccessor || "id";
        const id = $9ba0f9a5c47c04f2$exports.access(data, get);
    ...
    indexOf(id) {
        const key = $9ba0f9a5c47c04f2$exports.identifyNull(id);
        if (!key) return null;
    ...
    async create(opts = {}) {
        const parentId = opts.parentId === undefined ? $9ba0f9a5c47c04f2$exports.getInsertParentId(this) : opts.parentId;
        const index = opts.index ?? $9ba0f9a5c47c04f2$exports.getInsertIndex(this);
        const type = opts.type ?? "leaf";
        const data = await $c0491d23d353beb3$var$safeRun(this.props.onCreate, {
            type: type,
            parentId: parentId,
            index: index,
    ...
    async delete(node) {
        ...
        const ids = idents.map($c0491d23d353beb3$var$identify);
        const nodes = ids.map((id)=>this.get(id)).filter((n)=>!!n);
        await $c0491d23d353beb3$var$safeRun(this.props.onDelete, {
            nodes: nodes,
            ids: ids
        });
    }
    edit(node) {
        const id = $c0491d23d353beb3$var$identify(node);
        this.resolveEdit({
            cancelled: true
        });
        this.scrollTo(id);
        this.dispatch((0, $19606728da91aedd$export$e1a8e267487c59d1)(id));
        return new Promise((resolve)=>{
            $c0491d23d353beb3$export$e2da3477247342d1.editPromise = resolve;
        });
    }
    async submit(identity, value) {
        if (!identity) return;
        const id = $c0491d23d353beb3$var$identify(identity);
        await $c0491d23d353beb3$var$safeRun(this.props.onRename, {
            id: id,
            name: value,
            node: this.get(id)
        });
        this.dispatch((0, $19606728da91aedd$export$e1a8e267487c59d1)(null));
        this.resolveEdit({
            cancelled: false,
            value: value
        });
    ...
    activate(id) {
        const node = this.get($c0491d23d353beb3$var$identifyNull(id));
        if (!node) return;
        $c0491d23d353beb3$var$safeRun(this.props.onActivate, node);
    }
    resolveEdit(value) {
        const resolve = $c0491d23d353beb3$export$e2da3477247342d1.editPromise;
        if (resolve) resolve(value);
        $c0491d23d353beb3$export$e2da3477247342d1.editPromise = null;
    }
     ...
     * just select it. */ if (this.props.selectionFollowsFocus) this.select(node);
            ...
            this.dispatch((0, $a95e14a2a021f1d6$export$d7ddd398f22d79ef)($c0491d23d353beb3$var$identify(node)));
            if (opts.scroll !== false) this.scrollTo(node);
            if (this.focusedNode) $c0491d23d353beb3$var$safeRun(this.props.onFocus, this.focusedNode);
        }
    }
    pageUp() {
    ...
    select(node, opts = {}) {
        if (!node) return;
        const id = $c0491d23d353beb3$var$identify(node);
        this.dispatch((0, $a95e14a2a021f1d6$export$d7ddd398f22d79ef)(id));
        this.dispatch((0, $817c2f134e791dac$export$e324594224ef24da).only(id));
        this.dispatch((0, $817c2f134e791dac$export$e324594224ef24da).anchor(id));
        this.dispatch((0, $817c2f134e791dac$export$e324594224ef24da).mostRecent(id));
        this.scrollTo(id, opts.align);
        if (this.focusedNode) $c0491d23d353beb3$var$safeRun(this.props.onFocus, this.focusedNode);
        $c0491d23d353beb3$var$safeRun(this.props.onSelect, this.selectedNodes);
    }
    deselect(node) {
        if (!node) return;
        const id = $c0491d23d353beb3$var$identify(node);
        this.dispatch((0, $817c2f134e791dac$export$e324594224ef24da).remove(id));
    }
    selectMulti(identity) {
        const node = this.get($c0491d23d353beb3$var$identifyNull(identity));
        if (!node) return;
        this.dispatch((0, $a95e14a2a021f1d6$export$d7ddd398f22d79ef)(node.id));
        this.dispatch((0, $817c2f134e791dac$export$e324594224ef24da).add(node.id));
        this.dispatch((0, $817c2f134e791dac$export$e324594224ef24da).anchor(node.id));
        this.dispatch((0, $817c2f134e791dac$export$e324594224ef24da).mostRecent(node.id));
        this.scrollTo(node);
        if (this.focusedNode) $c0491d23d353beb3$var$safeRun(this.props.onFocus, this.focusedNode);
        $c0491d23d353beb3$var$safeRun(this.props.onSelect, this.selectedNodes);
    }
    selectContiguous(identity) {
        ...
        this.dispatch((0, $a95e14a2a021f1d6$export$d7ddd398f22d79ef)(id));
        this.dispatch((0, $817c2f134e791dac$export$e324594224ef24da).remove(this.nodesBetween(anchor, mostRecent)));
        this.dispatch((0, $817c2f134e791dac$export$e324594224ef24da).add(this.nodesBetween(anchor, $c0491d23d353beb3$var$identifyNull(id))));
        this.dispatch((0, $817c2f134e791dac$export$e324594224ef24da).mostRecent(id));
        this.scrollTo(id);
        if (this.focusedNode) $c0491d23d353beb3$var$safeRun(this.props.onFocus, this.focusedNode);
        $c0491d23d353beb3$var$safeRun(this.props.onSelect, this.selectedNodes);
    ...
    deselectAll() {
        this.dispatch((0, $817c2f134e791dac$export$e324594224ef24da).clear());
        this.dispatch((0, $817c2f134e791dac$export$e324594224ef24da).anchor(null));
        this.dispatch((0, $817c2f134e791dac$export$e324594224ef24da).mostRecent(null));
        $c0491d23d353beb3$var$safeRun(this.props.onSelect, this.selectedNodes);
    }
    selectAll() {
        this.dispatch((0, $817c2f134e791dac$export$e324594224ef24da).set(new Set(Object.keys(this.idToIndex))));
        this.dispatch((0, $a95e14a2a021f1d6$export$d7ddd398f22d79ef)(this.lastNode?.id));
        this.dispatch((0, $817c2f134e791dac$export$e324594224ef24da).anchor(this.firstNode));
        this.dispatch((0, $817c2f134e791dac$export$e324594224ef24da).mostRecent(this.lastNode));
        if (this.focusedNode) $c0491d23d353beb3$var$safeRun(this.props.onFocus, this.focusedNode);
        $c0491d23d353beb3$var$safeRun(this.props.onSelect, this.selectedNodes);
    }
    ...
    hideCursor() {
        this.dispatch((0, $21a3cfea9624f26e$export$e324594224ef24da).cursor({
            type: "none"
        }));
    }
    showCursor(cursor) {
        this.dispatch((0, $21a3cfea9624f26e$export$e324594224ef24da).cursor(cursor));
    }
    /* Visibility */ open(identity) {
        const id = $c0491d23d353beb3$var$identifyNull(identity);
        if (!id) return;
        if (this.isOpen(id)) return;
        this.dispatch((0, $9b3f76f5baa4c1e3$export$e324594224ef24da).open(id, this.isFiltered));
        $c0491d23d353beb3$var$safeRun(this.props.onToggle, id);
    }
    close(identity) {
        const id = $c0491d23d353beb3$var$identifyNull(identity);
        if (!id) return;
        if (!this.isOpen(id)) return;
        this.dispatch((0, $9b3f76f5baa4c1e3$export$e324594224ef24da).close(id, this.isFiltered));
        $c0491d23d353beb3$var$safeRun(this.props.onToggle, id);
    }
    toggle(identity) {
        const id = $c0491d23d353beb3$var$identifyNull(identity);
    ...
    openParents(identity) {
        const id = $c0491d23d353beb3$var$identifyNull(identity);
        if (!id) return;
        const node = $9ba0f9a5c47c04f2$exports.dfs(this.root, id);
    ...
    openAll() {
        $9ba0f9a5c47c04f2$exports.walk(this.root, (node)=>{
    ...
    /* Scrolling */ scrollTo(identity, align = "smart") {
        ...
        const id = $c0491d23d353beb3$var$identify(identity);
        this.openParents(id);
        return $9ba0f9a5c47c04f2$exports.waitFor(()=>id in this.idToIndex).then(()=>{
    ...
    isOpen(id) {
        if (!id) return false;
        if (id === (0, $b4b29088977a3260$export$ec71a3379b43ae5c)) return true;
    ...
    isDraggable(data) {
        ...
        return !$9ba0f9a5c47c04f2$exports.access(data, check) ?? true;
    }
    isDroppable(data) {
    ...
    isDragging(node) {
        const id = $c0491d23d353beb3$var$identifyNull(node);
        if (!id) return false;
    ...
    /* Tree Event Handlers */ onFocus() {
        ...
        if (node) this.dispatch((0, $a95e14a2a021f1d6$export$d7ddd398f22d79ef)(node.id));
    }
    onBlur() {
        this.dispatch((0, $a95e14a2a021f1d6$export$6b6c976e46a06288)());
    }
    ...
    /* Get Renderers */ get renderContainer() {
        return this.props.renderContainer || (0, $c937fea98c8ffb92$export$ff4858a4110d9246);
    }
    get renderRow() {
        return this.props.renderRow || (0, $f8cb92545200caa8$export$f9c541e71856c524);
    }
    get renderNode() {
        return this.props.children || (0, $7b23ad5b674e8347$export$909e23cbfbbd3351);
    }
    get renderDragPreview() {
        return this.props.renderDragPreview || (0, $41defe7a4d688623$export$84e211ad8431a387);
    }
    get renderCursor() {
        return this.props.renderCursor || (0, $cef5e4428309da5a$export$6cb3c16721363d11);
    }
}
...
function $62b7bd28b463c873$export$1650419e431d3ba3(state = {
    id: null,
    idWillReceiveDrop: null
}, action) {
    switch(action.type){
...
const $e241e922652141c7$export$a8a69c316169e623 = (0, $8zHUo$redux.combineReducers)({
    nodes: (0, $8zHUo$redux.combineReducers)({
        focus: $a95e14a2a021f1d6$export$1650419e431d3ba3,
        edit: $19606728da91aedd$export$1650419e431d3ba3,
        open: $9b3f76f5baa4c1e3$export$1650419e431d3ba3,
        selection: $817c2f134e791dac$export$1650419e431d3ba3,
        drag: $62b7bd28b463c873$export$1650419e431d3ba3
    }),
    dnd: $21a3cfea9624f26e$export$1650419e431d3ba3
});
...
const $c2b3fa0275b8fe8e$var$SERVER_STATE = (0, $8a51f8cf5a68a06f$export$d4c72bab9d6cc13a)();
function $c2b3fa0275b8fe8e$export$c49dab5eb1b4ce0c({ treeProps: treeProps , imperativeHandle: imperativeHandle , children: children  }) {
    const list = (0, $8zHUo$react.useRef)(null);
    const listEl = (0, $8zHUo$react.useRef)(null);
    const store = (0, $8zHUo$react.useRef)((0, $8zHUo$redux.createStore)((0, $e241e922652141c7$export$a8a69c316169e623), (0, $8a51f8cf5a68a06f$export$d4c72bab9d6cc13a)(treeProps)));
    const state = (0, $8zHUo$usesyncexternalstoreshim.useSyncExternalStore)(store.current.subscribe, store.current.getState, ()=>$c2b3fa0275b8fe8e$var$SERVER_STATE);
    /* The tree api object is stable. */ const api = (0, $8zHUo$react.useMemo)(()=>{
        return new (0, $c0491d23d353beb3$export$e2da3477247342d1)(store.current, treeProps, list, listEl);
    }, []);
    /* Make sure the tree instance stays in sync */ const updateCount = (0, $8zHUo$react.useRef)(0);
    ...
    /* Expose the tree api */ (0, $8zHUo$react.useImperativeHandle)(imperativeHandle, ()=>api);
    /* Change selection based on props */ (0, $8zHUo$react.useEffect)(()=>{
        if (api.props.selection) api.select(api.props.selection);
        else api.deselectAll();
    }, [
        api.props.selection
    ]);
    /* Clear visability for filtered nodes */ (0, $8zHUo$react.useEffect)(()=>{
        if (!api.props.searchTerm) store.current.dispatch((0, $9b3f76f5baa4c1e3$export$e324594224ef24da).clear(true));
    }, [
        api.props.searchTerm
    ]);
    return /*#__PURE__*/ (0, $8zHUo$reactjsxruntime.jsx)((0, $53e78f2af9ed7736$export$feef243b04ff4151).Provider, {
        value: api,
        children: /*#__PURE__*/ (0, $8zHUo$reactjsxruntime.jsx)((0, $53e78f2af9ed7736$export$d0c71bc5e3e2d897).Provider, {
            value: updateCount.current,
            children: /*#__PURE__*/ (0, $8zHUo$reactjsxruntime.jsx)((0, $53e78f2af9ed7736$export$f6d467aa8b3786af).Provider, {
                value: state.nodes,
                children: /*#__PURE__*/ (0, $8zHUo$reactjsxruntime.jsx)((0, $53e78f2af9ed7736$export$2d5c5ceac203fc1e).Provider, {
                    value: state.dnd,
                    children: /*#__PURE__*/ (0, $8zHUo$reactjsxruntime.jsx)((0, $8zHUo$reactdnd.DndProvider), {
                        backend: (0, $8zHUo$reactdndhtml5backend.HTML5Backend),
                        options: {
...
function $f00eaee6ad695fd1$export$5a6c424b1725f44f() {
    const tree = (0, $53e78f2af9ed7736$export$367b0f2231a90ba0)();
    // In case we drop an item at the bottom of the list
    const [, drop] = (0, $8zHUo$reactdnd.useDrop)(()=>({
            accept: "NODE",
            hover: (item, m)=>{
                if (!m.isOver({
                    shallow: true
...
function $6df89ee08de437d5$export$a6ee728c3c6ef11d(props) {
    (0, $f00eaee6ad695fd1$export$5a6c424b1725f44f)();
...
function $2d57f0980c0badbe$export$cdf2ef3f6364d85() {
    const tree = (0, $53e78f2af9ed7736$export$367b0f2231a90ba0)();
    const Container = tree.props.renderContainer || (0, $c937fea98c8ffb92$export$ff4858a4110d9246);
    return /*#__PURE__*/ (0, $8zHUo$reactjsxruntime.jsx)((0, $8zHUo$reactjsxruntime.Fragment), {
        children: /*#__PURE__*/ (0, $8zHUo$reactjsxruntime.jsx)(Container, {})
    });
}
...
function $c8248392f8ee2782$export$3e21b60650ec7e55() {
    const tree = (0, $53e78f2af9ed7736$export$367b0f2231a90ba0)();
    const { offset: offset , mouse: mouse , item: item , isDragging: isDragging  } = (0, $8zHUo$reactdnd.useDragLayer)((m)=>{
        return {
    ...
    const DragPreview = tree.props.renderDragPreview || (0, $41defe7a4d688623$export$84e211ad8431a387);
    return /*#__PURE__*/ (0, $8zHUo$reactjsxruntime.jsx)(DragPreview, {
        offset: offset,
        mouse: mouse,
        id: item?.id || null,
        dragIds: item?.dragIds || [],
...
var $dd5c2e521072dd97$exports = {};

$parcel$export($dd5c2e521072dd97$exports, "useSimpleTree", () => $dd5c2e521072dd97$export$dcd27aa2043b2724);

var $1ca56f8f01823e9f$exports = {};

$parcel$export($1ca56f8f01823e9f$exports, "SimpleTree", () => $1ca56f8f01823e9f$export$e32206264f456dce);
class $1ca56f8f01823e9f$export$e32206264f456dce {
    constructor(data){
        this.root = $1ca56f8f01823e9f$var$createRoot(data);
    }
    get data() {
...
function $1ca56f8f01823e9f$var$createRoot(data) {
    const root = new $1ca56f8f01823e9f$var$SimpleNode({
        id: "ROOT"
    }, null);
    root.children = data.map((d)=>$1ca56f8f01823e9f$var$createNode(d, root));
    return root;
}
function $1ca56f8f01823e9f$var$createNode(data, parent) {
    const node = new $1ca56f8f01823e9f$var$SimpleNode(data, parent);
    if (data.children) node.children = data.children.map((d)=>$1ca56f8f01823e9f$var$createNode(d, node));
    return node;
}
class $1ca56f8f01823e9f$var$SimpleNode {
    ...
    addChild(data, index) {
        const node = $1ca56f8f01823e9f$var$createNode(data, this);
...
let $dd5c2e521072dd97$var$nextId = 0;
function $dd5c2e521072dd97$export$dcd27aa2043b2724(initialData) {
    const [data, setData] = (0, $8zHUo$react.useState)(initialData);
    const tree = (0, $8zHUo$react.useMemo)(()=>new (0, $1ca56f8f01823e9f$export$e32206264f456dce)(data), [
        data
    ]);
    const onMove = (args)=>{
    ...
    const onCreate = ({ parentId: parentId , index: index , type: type  })=>{
        const data = {
            id: `simple-tree-id-${$dd5c2e521072dd97$var$nextId++}`,
            name: ""
        };
...
function $2fb72e3f2de5ef22$export$d227906824a13416(props) {
...
Use the data prop if you want to provide your own handlers.`);
     ...
     *   */ const [data, controller] = (0, $dd5c2e521072dd97$export$dcd27aa2043b2724)(props.initialData);
        return {
            ...props,
            ...controller,
            data: data
...
const $4e2fcf2ca763d051$export$7fbedc92909ed28e = /*#__PURE__*/ (0, $8zHUo$react.forwardRef)(function Tree(props, ref) {
    const treeProps = (0, $2fb72e3f2de5ef22$export$d227906824a13416)(props);
    return /*#__PURE__*/ (0, $8zHUo$reactjsxruntime.jsxs)((0, $c2b3fa0275b8fe8e$export$c49dab5eb1b4ce0c), {
        treeProps: treeProps,
        imperativeHandle: ref,
        children: [
            /*#__PURE__*/ (0, $8zHUo$reactjsxruntime.jsx)((0, $6df89ee08de437d5$export$a6ee728c3c6ef11d), {
                children: /*#__PURE__*/ (0, $8zHUo$reactjsxruntime.jsx)((0, $2d57f0980c0badbe$export$cdf2ef3f6364d85), {})
            }),
            /*#__PURE__*/ (0, $8zHUo$reactjsxruntime.jsx)((0, $c8248392f8ee2782$export$3e21b60650ec7e55), {})
        ]
    });
});


var $740b797f1cc98dd7$exports = {};


var $570dbf7380f9951d$exports = {};


var $accc6c82e41277d3$exports = {};
...
$parcel$exportWildcard(module.exports, $740b797f1cc98dd7$exports);
$parcel$exportWildcard(module.exports, $570dbf7380f9951d$exports);
$parcel$exportWildcard(module.exports, $accc6c82e41277d3$exports);
$parcel$exportWildcard(module.exports, $a037376675af076f$exports);
$parcel$exportWildcard(module.exports, $c0491d23d353beb3$exports);
$parcel$exportWildcard(module.exports, $1ca56f8f01823e9f$exports);
$parcel$exportWildcard(module.exports, $dd5c2e521072dd97$exports);
